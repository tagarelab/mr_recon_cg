...
loc = "C:\\Yale\\MRRC\\mr_recon_cg\\data\\240828_EMI_hunt_S3E4\\EMI_Probe_Pos_2\\"
...
editer.editer_process_all_files(loc, interleave, N_ch, rep, seg, sig_ch_name, emi_ch_name, new_file_prefix='Pos2_')
