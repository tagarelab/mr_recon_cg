...
loc = "C:\\Yale\\MRRC\\mr_recon_cg\\data\\240911_EMI_hunt_S2E5\\EMI_pos_1\\"
...
editer.editer_process_all_files(loc, interleave, N_ch, rep, seg, sig_ch_name, emi_ch_name, new_file_prefix='Pos1_')
