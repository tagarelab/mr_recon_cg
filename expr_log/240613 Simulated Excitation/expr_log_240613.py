...
vis.scatter3d(np.linalg.norm(B1_raw, axis=0), X_axis, Y_axis, Z_axis, xlim=xlim, ylim=ylim, zlim=zlim, mask=slice,
              title='B1 (mT)')
vis.show_all_plots()
vis.scatter3d(np.linalg.norm(B1_raw, axis=0), X_axis, Y_axis, Z_axis, xlim=xlim, ylim=ylim, zlim=zlim, mask=SI_cut,
              title='B1 (mT)')
vis.show_all_plots()
